...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-white text-slate-800 font-sans">
      ...
      <section id="how-it-works" className="scroll-mt-20 border-b border-slate-200/80 bg-white px-6 py-20 sm:py-24">
